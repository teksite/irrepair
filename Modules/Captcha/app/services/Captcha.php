...
class Captcha
{
    ...
    public function __construct(
        ...
        $this->assetspath=Module::getModulePath('Captcha').'/resources/assets/';
        $this->fontsDirectory = config('captcha.fontsDirectory',  $this->assetspath. 'fonts');
    }
    ...
    {
        $this->backgrounds = $this->files->files($this->assetspath.'backgrounds');
    ...
    public function onlyCheck(string $value): bool
    {
        if (!$this->session->has('captcha')) {
            return false;
        }

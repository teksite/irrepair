...
class MakeApiRequest extends Command
{
     ...
     */
    protected $signature = 'module:make-api-request {class} {Module}';

    /**
     * The console command description.
     */
    protected $description = 'make api request class to return Api demands';
    ...
    public function handle()
    {
        ...
        $directory = base_path('Modules/'.$module.'/app/Http/Requests/' . $namespace );
    ...
    {
        $stubPath=module_path('Main', 'resources/stubs/api-request.stub');

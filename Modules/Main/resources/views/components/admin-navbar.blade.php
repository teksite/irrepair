        ...
        <ul class="floating_menu-list">
            <li class="floating_menu-item">
                ...
                <button type="button" role="button" title="{{__('log out')}}"
                    ...
                    <i class="tkicon fill-none stroke-red-600" size="16" data-icon="turn-off"></i>
                </button>
            </li>
            <li class="floating_menu-item">
                <a href="{{route('admin.index')}}" title="{{__('admin dashboard')}}">
                    <i class="tkicon fill-none stroke-white" data-icon="gears"></i>
                </a>
            </li>
            <li class="floating_menu-item">
                <a href="{{route('panel.index')}}" title="{{__('user panel')}}">
                    <i class="tkicon fill-none stroke-white" data-icon="user"></i>
                </a>
            </li>
            @if($editAddressPage)
                <li class="floating_menu-item">
                    <a href="{{$editAddressPage}}" target="_blank" title="{{__('edit')}}" id="adminEditPageLink">
                        <i class="tkicon fill-none stroke-white" data-icon="pen"></i>
                    </a>
                </li>
            @endif
        </ul>

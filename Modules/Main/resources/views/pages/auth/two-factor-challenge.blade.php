<x-main::auth-layout>
    ...
    <div class="p-3">
        <div class="flex items-center justify-center gap-3 mb-6">
            <i class="tkicon fill-none stroke-gray-200 block text-center"  size="50" data-icon="lock-open"></i>
            <h2 class="text-center text-gray-200 mb-0">{{__('two factor authentication')}}</h2>
        </div>

        <div class="slider">
            <div class="slide {{$errors->has('code') ? 'active-slide' : ''}}" id="0">
                @include('main::pages.auth.twofactor.two-factor-code')
            </div>
            <div class="slide {{$errors->has('recovery_code') ? 'active-slide' : ''}}" id="1">
                @include('main::pages.auth.twofactor.two-factor-recovery-code')
        ...
        <div class="flex justify-between items-center gap-3 mt-3 px-3">
            ...
            <div>
                <a href="/"
                   class="text-gray-200 text-sm flex items-center gap-1">

    ...
    <form method="POST" action="{{route('two-factor.login')}}" class="formAction">
        ...
        <div class="mb-3">
            <div class="flex items-center border border-slate-200 rounded">
                <x-main::input.label for="recovery_code" :value="__('code')" class="flex flex-col justify-center items-center !mb-0 p-3 text-white border-e border-slate-200"/>
            ...
            <x-main::input.error :messages="$errors->get('recovery_code')" class="mt-2"/>
        </div>

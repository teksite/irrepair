            ...
            <div>
                <div class="grid gap-3 lg:grid-cols-2">
                    <div class="mb-3">
                        ...
                        <x-main::input.text id="name" class="block w-full" type="text" name="name" :value="old('name')" required/>
                    ...
                    <div class="mb-3">
                        ...
                        <x-main::input.text id="name" class="block w-full" type="text" name="username" :value="old('username')" required/>

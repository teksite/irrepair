            ...
            <div class="">
                ...
                <div class="p-3 my-3">
                    <div class="flex items-center justify-center gap-3 mb-3">
                        <i class="tkicon fill-none stroke-white block text-center" size="50" data-icon="lock-opened"></i>
                ...
                <div>
                    ...
                    <div class="flex justify-between items-center flex-wrap gap-6">
                        <a href="/" class="text-gray-200 hover:text-secondary-500 text-sm flex items-center gap-1">
